...
from configP4 import FolderToBackup, LocationFolderToBackup, BackupFolder, LocationBackupFolder, MaxThreadsUsed, TimeSinceLastBackup, CompareFolderTime, TargetRecoveryfolder, RestoreZipFolder
import itertools
from time import sleep

QUIT = '8'
COMMANDS = ('1', '2', '3', '4', '5', '8')
# My menu System
                    ...
                    try:
                        ...
                        # If the bytes size of the files are not equal copy and archive changes
                            ...
                            try:
                                now = datetime.datetime.now()
                                nowformat = now.strftime("%Y-%m-%d %H-%M-%S")
                                distutils.dir_util.copy_tree(LocationFolderToBackup,
                                                             LocationBackupFolder + "Updated Backup" + " " + str(
                                                                 nowformat))
